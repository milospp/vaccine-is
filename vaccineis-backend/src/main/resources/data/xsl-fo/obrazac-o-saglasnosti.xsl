                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block margin-top="-30px">
                        ...
                        <fo:inline-container inline-progression-dimension="15%" margin-left="10px">
                            <fo:block>
                                <fo:external-graphic src='url("/home/dalibor/Desktop/vaccine-is/vaccineis-backend/src/main/resources/static/images/Screenshot from 2022-02-08 11-18-10.png")' height="20px" content-width="0.8in" />
                            </fo:block>
                        </fo:inline-container>
