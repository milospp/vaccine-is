                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block margin-top="-30px">
                        <fo:inline-container inline-progression-dimension="50%">
                            <fo:block>
                                <fo:external-graphic src='url("/home/dalibor/Desktop/vaccine-is/vaccineis-backend/src/main/resources/static/images/Screenshot from 2022-02-08 02-50-25.png")' content-height="scale-to-fit" height="100px" content-width="1.3in" scaling="non-uniform"/>
                            </fo:block>
                        </fo:inline-container>

                        <fo:inline-container inline-progression-dimension="50%">
                            <fo:block>
                                <fo:external-graphic src='url("/home/dalibor/Desktop/vaccine-is/vaccineis-backend/src/main/resources/static/images/Screenshot from 2022-02-08 02-49-37.png")'  content-height="scale-to-fit" height="100px" content-width="3.50in" scaling="non-uniform"/>
                            </fo:block>
                        </fo:inline-container>
                    </fo:block>
                    ...
                    <fo:block-container>
                        ...
                        <fo:block margin-top="15px">
                            ...
                            <fo:inline-container inline-progression-dimension="20%">
                                <fo:block>
                                    <fo:external-graphic src='url("/home/dalibor/Desktop/vaccine-is/vaccineis-backend/src/main/resources/static/images/Screenshot from 2022-02-08 02-51-26.png")' content-height="scale-to-fit" height="100px" content-width="1.3in" scaling="non-uniform"/>
                                </fo:block>
                            </fo:inline-container>
                        </fo:block>
