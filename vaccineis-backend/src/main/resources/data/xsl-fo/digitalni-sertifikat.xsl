                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block margin-top="-30px">
                        <fo:inline-container inline-progression-dimension="15%">
                            <fo:block margin-left="10px">
                                <fo:external-graphic src='url("/home/dalibor/Desktop/vaccine-is/vaccineis-backend/src/main/resources/static/images/Screenshot from 2022-02-08 11-17-12.png")' height="20px" content-width="1.0in" scaling="non-uniform"/>
                            </fo:block>
                        </fo:inline-container>
                        ...
                        <fo:inline-container inline-progression-dimension="20%">
                            <fo:block margin-left="-10px">
                                <fo:external-graphic src='url("/home/dalibor/Desktop/vaccine-is/vaccineis-backend/src/main/resources/static/images/Screenshot from 2022-02-08 02-51-26.png")'  height="20px" content-width="1.7in" scaling="non-uniform"/>
                            </fo:block>
                        </fo:inline-container>
                    </fo:block>
                    ...
                    <fo:block margin-top="10px">
                        <fo:inline-container inline-progression-dimension="10%">
                            <fo:block>
                                <fo:external-graphic src='url("/home/dalibor/Desktop/vaccine-is/vaccineis-backend/src/main/resources/static/images/Screenshot from 2022-02-08 11-18-10.png")' height="10px" content-width="0.8in" />
                            </fo:block>
                        </fo:inline-container>
                        ...
                        <fo:inline-container inline-progression-dimension="50%">
                            <fo:block margin-left="40px">
                                <fo:external-graphic src='url("/home/dalibor/Desktop/vaccine-is/vaccineis-backend/src/main/resources/static/images/Screenshot from 2022-02-08 11-27-59.png")' height="10px" content-width="2.8in" />
                            </fo:block>
                        </fo:inline-container>
                    </fo:block>
