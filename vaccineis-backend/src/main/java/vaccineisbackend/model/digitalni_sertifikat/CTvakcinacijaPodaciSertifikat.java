...
public class CTvakcinacijaPodaciSertifikat {
    ...
    protected List<CTvakcinacijaPodaciSertifikat.Doza> doza;
     ...
     * {@link CTvakcinacijaPodaciSertifikat.Doza }
     * 
     * 
     */
    public List<CTvakcinacijaPodaciSertifikat.Doza> getDoza() {
        if (doza == null) {
            doza = new ArrayList<CTvakcinacijaPodaciSertifikat.Doza>();
        }
        return this.doza;
    }
